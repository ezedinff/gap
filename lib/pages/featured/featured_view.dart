import 'package:gap/pages/featured/featured_bloc.dart';
import 'package:gap/pages/featured/featured_events.dart';
import 'package:gap/pages/featured/featured_streams.dart';
import 'package:gap/repository/notice_repository/model/notice.dart';
import 'package:gap/widgets/erro_conection.dart';
import 'package:gap/widgets/pageTransform/intro_page_item.dart';
import 'package:gap/widgets/pageTransform/page_transformer.dart';
  ...
  _buildFeatureds(FeaturedStreams streams) {
    return StreamListener<List<Notice>>(
        ...
        builder: (BuildContext context, snapshot) {
          ...
          Widget fearured = PageTransformer(pageViewBuilder: (context, visibilityResolver) {
